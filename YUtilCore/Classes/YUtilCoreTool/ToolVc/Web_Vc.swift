...
//        }
    ...
    override public func setupUI() {
        ...
        self.bridge?.registerHandler("getactivedata", handler:{  data , response in
            ...
            YUtilCore.sharedInstance.activeData[YUtilCore.sharedInstance.fieldValue] = YUtilCore.sharedInstance.activeid
            response(YUtilCore.sharedInstance.activeData)
        })
...
//        self.loadWebView()
   ...
   public func  loadWebView() {
        if let webUrl = self.webUrl {
            ...
            setHttpCookies(url)
            request.setValue(YUtilCore.sharedInstance.activeid, forHTTPHeaderField:YUtilCore.sharedInstance.fieldValue)
    ...
    public func  setHttpCookies(_ url:URL) {
        ...
        props[HTTPCookiePropertyKey.name] = YUtilCore.sharedInstance.fieldValue
        props[HTTPCookiePropertyKey.value] = YUtilCore.sharedInstance.activeid
